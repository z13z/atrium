...
import ch.tutteli.atrium.logic.impl.creating.iterablelike.contains.searchbehaviours.InOrderOnlyGroupedSearchBehaviourImpl
...
interface InOrderOnlyGroupedSearchBehaviour : IterableLikeContains.SearchBehaviour{
    companion object {
        operator fun invoke(): InOrderOnlyGroupedSearchBehaviour =
            InOrderOnlyGroupedSearchBehaviourImpl()
    }
}

...
interface Contains {
     ...
     */
    interface CheckerStep<T : Any, out S : SearchBehaviour, out C : Checker, out B : Builder<T, S>> {
        /**
         ...
         *
         * It typically contains the [Checker] this builder created and might contain other [Checker]s which typically
         * precedent builders created.
         */
        val checkers: List<C>
    }
    ...
    interface Creator<T : Any, in SC> {
         ...
         * subject the given [container] provides, based on the given [searchCriteria].
         *
         ...
         *
         * @param container Provides the subject for which the [AssertionGroup] is created.
